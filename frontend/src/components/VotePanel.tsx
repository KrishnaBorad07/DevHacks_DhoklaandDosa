            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  background: isTargeted ? 'rgba(200,0,0,0.15)' : 'rgba(20,20,20,0.8)',
                  border: `1px solid ${isTargeted ? 'var(--noir-red)' : hasMaxVotes ? 'rgba(255,215,0,0.5)' : 'rgba(255,215,0,0.1)'}`,
                  borderRadius: 4,
                  cursor: alive && !isSelf && phase === 'vote' ? 'pointer' : 'default',
                  boxShadow: isTargeted ? 'var(--shadow-red)' : hasMaxVotes ? '0 0 10px rgba(255,215,0,0.25)' : 'none',
